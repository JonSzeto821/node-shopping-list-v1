...
//my turn - create new items for recipe 
Recipes.create('chocolate milk', ['cocoa', 'milk', 'sugar']);
Recipes.create('strawberry milk', ['strawberry', 'milk', 'sugar']);
Recipes.create('coffee', ['coffee beans', 'water', 'sugar']);
...
//render the recipe items when root of the route is called with GET
//return all current Recipe items 
